        ...
        public MainWindow()
        {
            ...
            try
            {
                ...
                List<string> createTableQuery = new List<string> { "create table if not exists Avviso (Titolo Varchar(50) not null, Data date not null, Codice_fiscale Varchar(16) not null, constraint ID_Avviso_ID primary key (Codice_fiscale, Titolo, Data));",
                    ...
                    "create table if not exists PRENOTAZIONE_OMBRELLONE (Data_inzio date not null, Data_fine date not null, Numero_lettini_aggiuntivi int not null, Codice_fiscale Varchar(16) not null, Numero_riga int not null, Numero_colonna int not null, constraint ID_PRENOTAZIONE_OMBRELLONE_ID primary key (Data_inzio, Numero_riga, Numero_colonna));",
